...
<div className='flex flex-col gap-2'>
      ...
      <p className='text-sm text-gray-200 pb-20'>Build out a whole workout plan.</p>
        <div className='flex justify-end pb-2 hidden'>
          <p className='inline-flex py-1 px-4 mr-2 text-white font-semibold border-white border-[1px] rounded-full'>Plan Workout
    ...
    <Link to={'/freestyle'}>
      ...
      <p className='text-sm text-gray-200 pb-20'>Jump straight into your workout and pick as you go.</p>
        <div className='flex justify-end pb-2 hidden'>
          <p className='inline-flex py-1 px-4 mr-2 text-white font-semibold border-white border-[1px] rounded-full'>Start Workout
    ...
    <Link to={'/randomizer'}>
      ...
      <p className='text-sm text-gray-200 pb-20'>Auto generate a new workout plan.</p>
        <div className='flex justify-end pb-2 hidden'>
          <p className='inline-flex py-1 px-4 mr-2 text-white font-semibold border-white border-[1px] rounded-full'>Suprise Workout
