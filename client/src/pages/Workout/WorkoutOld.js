      ...
      {startingExercise && !end &&
        <div className="py-24 text-center">
          ...
          <div className='flex flex-row gap-2 my-2 mt-32 text-center'>
            ...
            <div onClick={handleEndWorkout} className='flex-1 p-4 bg-red-500 rounded text-white'>Stop</div>
            ...
            <div onClick={handleEndWorkout} className='flex-1 p-4 bg-red-500 rounded text-white font-extrabold text-outline'>Stop</div>
            <div onClick={handleViewExcercises} className='flex-1 p-4 bg-purple-400 rounded text-white font-extrabold text-outline'>Excercises</div>
            <div onClick={handleViewLog} className='flex-1 p-4 bg-blue-400 rounded text-white font-extrabold text-outline'>Logs</div>
            <div onClick={handleNextExercise} className='flex-1 p-4 bg-green-500 rounded text-white font-extrabold text-outline'>Next</div>
          </div> */}

          {/* <div className='flex flex-row gap-2 my-2 mt-32 text-center'>
            <div onClick={handleEndWorkout} className='flex-1 py-2 px-4 bg-gradient-to-br from-red-400 to-red-500 border-[6px] border-red-600 rounded-2xl text-xl font-extrabold text-outline'>
              Stop
              </div>
            <div onClick={handleViewExcercises} className='flex-1 py-2 px-4 bg-gradient-to-br from-purple-400 to-purple-500 border-[6px] border-purple-600 rounded-2xl text-white'>Excercises</div>
            <div onClick={handleViewLog} className='flex-1 py-2 px-4 bg-gradient-to-br from-blue-400 to-blue-500 border-[6px] border-blue-600 rounded-2xl text-white'>Logs</div>
            <div onClick={handleNextExercise} className='flex-1 py-2 px-4 bg-gradient-to-br from-green-400 to-green-500 border-[6px] border-green-600 rounded-2xl text-white'>Next</div>
          </div>

          <div className='flex flex-row gap-2 my-2 mt-32 text-center'>

            <div onClick={handleEndWorkout} className='flex-1 p-4 bg-red-400 rounded text-white font-extrabold text-outline'>Stop</div>
            <div onClick={handleViewExcercises} className='flex-1 p-4 bg-purple-400 rounded text-white'>Excercises</div>
            <div onClick={handleViewLog} className='flex-1 p-4 bg-blue-400 rounded text-white'>Logs</div>
            <div onClick={handleNextExercise} className='flex-1 p-4 bg-green-500 rounded text-white'>Next</div>
          </div>
          ...
          <div className='flex flex-row gap-2 my-2 mt-32 text-center'>
            ...
            <div onClick={handleNextExercise} className='flex-1 py-2 px-8 border-[4px] border-green-500 bg-[linear-gradient(to_bottom,_#0094CF_85%,_#004459_95%)] rounded text-black font-semibold'>Next</div>
            <div onClick={handleNextExercise} className='flex-1 py-2 px-8 bg-gradient-to-b from-[#0094CF] to-[#004459] rounded text-black font-semibold'>
              Next
            </div>
            <div onClick={handleNextExercise} className='flex-1 py-2 px-8 bg-[linear-gradient(to_bottom,_#0094CF_65%,_#004459_75%)] rounded text-black font-semibold'>Next</div>
            <div onClick={handleNextExercise} className='flex-1 py-2 px-8 border-[4px] border-green-500 bg-[linear-gradient(to_bottom,_#4ade80_85%,_#22c55e_95%)] rounded text-black font-semibold'>Next</div>
            <div className='border-[4px] border-blue-300 bg-gradient-to-b from-blue-400 to-blue-600 text-white font-bold text-xl px-4 py-2 rounded shadow-md hover:brightness-110'>Example</div>
            <div className='bg-blue-500 text-white px-4 py-2 font-mono border-4 border-white rounded-none hover:bg-blue-600 shadow-[4px_4px_0px_#000]'>example</div>
            <div className='inline-block bg-blue-600 rounded p-0.5'>
              <button className='bg-blue-300 w-full h-full px-4 py-2 rounded text-white font-bold hover:bg-blue-400'>
                Example
                </button>
              </div>
            <button className='border-l-[4px] border-t-[4px] border-blue-600 flex flex-col h-12 w-40 rounded overflow-hidden shadow-md'>
              <div className='bg-blue-300 h-1/2 w-full'></div>
              <div className='bg-blue-600 h-1/2 w-full text-black flex items-center justify-center font-bold'>
                examplee
              </div>
            </button>
          </div> */}
