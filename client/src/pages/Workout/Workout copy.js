...
const Workout = () => {
  ...
  // const { from, split, bodyParts, image } = location.state
...
{startingExercise}
      ...
      {end ? (<div className="py-24 text-center">
        ...
        <div className="py-24 text-center">
          ...
          {/* <h3 className="text-left">Choose Starting Exercise</h3> */}
        ...
        <div className="py-24 text-center">
          ...
          {/* <div className="flex justify-between mt-4">
            <button className="bg-red-500 text-white p-2 rounded" onClick={handleEndWorkout}>
              End Workout
            </button>

            <button className="bg-blue-500 text-white p-2 rounded" onClick={handleNextExercise}>
              Next Exercise
            </button>
          </div> */}
